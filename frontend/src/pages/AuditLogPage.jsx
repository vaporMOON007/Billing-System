...
const ACTION_META = {
  ...
  APPROVE_USER:    { label: 'Approved user',   dot: 'bg-green-500' },
  REJECT_USER:     { label: 'Rejected user',   dot: 'bg-red-500' },
  RESET_PASSWORD:  { label: 'Reset password',  dot: 'bg-amber-400' },
  APPROVE_PASSWORD_RESET: { label: 'Approved reset request',  dot: 'bg-green-400' },
  REJECT_PASSWORD_RESET:  { label: 'Rejected reset request',  dot: 'bg-red-400' },
  DELETE_CLIENT:   { label: 'Deleted client',  dot: 'bg-red-500' },
  DELETE_PAYMENT:  { label: 'Deleted payment', dot: 'bg-orange-600' },
  OVERRIDE_EDIT_PAYMENT: { label: 'Edited payment', dot: 'bg-amber-500' },
